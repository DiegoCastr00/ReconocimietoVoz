...
class SpeakerFeatureExtractor:
    ...
    def process_audio(self, audio):
        ...
        features_dict = self.extract_features(audio)
        # Convertir el diccionario a array numpy
        features_array = np.array(list(features_dict.values()), dtype=float)
        
        # Reshape para tener forma (1, n_features)
